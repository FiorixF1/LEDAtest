...
void printBytes(unsigned char *data, int length) {
    ...
    int i;
    for (i = 0; i < length; ++i) {
        HAL_UART_Transmit(&huart3, (uint8_t*)buffer, sprintf(buffer, "%02X", data[i]), 0xFFFFFF);
    }
}
...
int main(void)
{
  ...
  while (count_keypair < 30)
  {
    ...
    HAL_UART_Receive(&huart3, (uint8_t *)entropy_string, 96, 0xFFFFFF);
    ...
    HAL_UART_Transmit(&huart3, (uint8_t *)SEED, strlen(SEED), 0xFFFFFF);
    ...
    HAL_UART_Transmit(&huart3, (uint8_t *)KEYPAIR_TIME, strlen(KEYPAIR_TIME), 0xFFFFFF);
    //itoa(keypair_time, number, 10);
    //number[strlen(number)] = 0;
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", keypair_time), 0xFFFFFF);
    ...
    HAL_UART_Transmit(&huart3, (uint8_t *)ENC_TIME, strlen(ENC_TIME), 0xFFFFFF);
    //itoa(enc_time, number, 10);
    //number[strlen(number)] = 0;
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", enc_time), 0xFFFFFF);
    ...
    HAL_UART_Transmit(&huart3, (uint8_t *)DEC_TIME, strlen(DEC_TIME), 0xFFFFFF);
    //itoa(dec_time, number, 10);
    //number[strlen(number)] = 0;
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
    //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", dec_time), 0xFFFFFF);
    printBytes(&dec_time, 8);
  
    // newline
    HAL_UART_Transmit(&huart3, (uint8_t *)NEWLINE, strlen(NEWLINE), 0xFFFFFF);
  ...
  HAL_UART_Transmit(&huart3, (uint8_t *)KEYPAIR, strlen(KEYPAIR), 0xFFFFFF);
  ...
  HAL_UART_Transmit(&huart3, (uint8_t *)MEAN_IS, strlen(MEAN_IS), 0xFFFFFF);
  //itoa((unsigned int)mean_keypair, number, 10);
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)mean_keypair), 0xFFFFFF);
  printBytes(&i_mean_keypair, 8);
  
  HAL_UART_Transmit(&huart3, (uint8_t *)VARIANCE_IS, strlen(VARIANCE_IS), 0xFFFFFF);
  //itoa((unsigned int)m2_keypair, number, 10);
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)m2_keypair), 0xFFFFFF);
  printBytes(&i_m2_keypair, 8);
  
  // results for crypto_kem_enc  
  HAL_UART_Transmit(&huart3, (uint8_t *)ENC, strlen(ENC), 0xFFFFFF);
  ...
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)mean_enc), 0xFFFFFF);
  ...
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)m2_enc), 0xFFFFFF);
  printBytes(&i_m2_enc, 8);
  
  // results for crypto_kem_dec
  HAL_UART_Transmit(&huart3, (uint8_t *)DEC, strlen(DEC), 0xFFFFFF);
  ...
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)mean_dec), 0xFFFFFF);
  ...
  //number[strlen(number)] = 0;
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, strlen(number), 0xFFFFFF);
  //HAL_UART_Transmit(&huart3, (uint8_t *)number, sprintf(number, "%d", (int)m2_dec), 0xFFFFFF);
